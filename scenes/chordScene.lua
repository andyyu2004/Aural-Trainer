...
--							Requires								--
----------------------------------------------------------------------
local sceneManager	= require ("classes.sceneManager")
...
function scene:create( event )
	...
	local options = { 
		minOctave = self.minOctave,
		maxOctave = self.maxOctave
	}
	
	-- call the the main game class and pass over the options table
	local sceneManager = sceneManager:new(sceneGroup, "chord", options)
