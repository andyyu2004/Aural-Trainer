...
function scene:create( event )
	...
	if ( "ended" == event.phase ) then
		...
		composer.gotoScene( "scenes.noteScene", options )
		end
	end
	...
	local function handleButtonEvent( event )
		...
		composer.gotoScene( "scenes.intervalScene", options )
		end
	end
	...
	local function handleButtonEvent( event )
		...
		composer.gotoScene( "scenes.chordScene", options )
		end
	end
	...
	local function handleButtonEvent( event )
		...
		composer.gotoScene( "scenes.scaleScene", options )
		end
	end
